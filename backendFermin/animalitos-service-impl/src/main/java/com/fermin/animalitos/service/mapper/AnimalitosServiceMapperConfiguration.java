...
@Configuration
public class AnimalitosServiceMapperConfiguration {

	@Bean
	public AnimalitosServiceMapper configurarInstanciaDelAnimalitosServiceMapper() {
		return Mappers.getMapper(AnimalitosServiceMapper.class);
	}
